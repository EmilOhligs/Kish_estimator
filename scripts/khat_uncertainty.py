...
Ausfuehren:
    python scripts/khat_uncertainty.py
    python scripts/khat_uncertainty.py --weights results/mace_energies_ensemble_L2c_testbig.npz
    python scripts/khat_uncertainty.py --boot 4000 --m-points 30
"""
...
def main():
    ...
    ap.add_argument("--weights", default="results/mace_energies_ensemble_L2c_testbig.npz",
    ...
    out = root / args.outdir / "khat_uncertainty.png"
