...
Beispiele:
    python scripts/neff_running_estimate.py --source real
    python scripts/neff_running_estimate.py --source lognormal --sigma 1.0 -n 2000
    python scripts/neff_running_estimate.py --source pareto --alpha 2.0 --shuffles 200
"""
...
def main():
    ...
    ap.add_argument("--weights", default=None,
                    help="Pfad zu vorhandenen Daten (.npy/.npz/.txt/.csv) - kein MACE-Neulauf. "
                         ...
                         "(z.B. results/mace_energies_*.npz) -> w_i wird bei --temperature berechnet.")
    ...
    out_png = root / "results" / f"neff_running_{tag}.png"
