...
Ausfuehren:
    python scripts/convergence_simulation.py
    python scripts/convergence_simulation.py --reps 1000 --pools 20 --with-khat
"""
...
# Messwerte aus results/mace_energies_ensemble_L2c_testbig.npz (L2c, 400 Frames, 300 K)
REAL_C = 0.3180
REAL_SKEW = 0.5027
REAL_KURT = 0.4071
REAL_N = 400
...
def main():
    ...
    ap.add_argument("--outdir", default="results/convergence")
    args = ap.parse_args()
