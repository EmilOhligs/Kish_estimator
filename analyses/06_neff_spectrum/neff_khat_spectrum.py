...
Ausfuehren:
    python analyses/neff_khat_spectrum.py
    python analyses/neff_khat_spectrum.py -n 5000 --orders 10 --grid 250
    python analyses/neff_khat_spectrum.py --resample --seed 1
    python analyses/neff_khat_spectrum.py --only lognormal_s2,pareto_a125

Ausgabe: (Ausgabeordner) <name>.png  je Verteilung
         (Ausgabeordner) summary.csv  Kennzahlen aller Verteilungen
"""
