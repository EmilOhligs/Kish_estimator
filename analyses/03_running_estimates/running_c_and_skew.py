...
Ausfuehren:
    python analyses/running_c_and_skew.py \
        --energies cache/mace_energies_ensemble_L2c_testbig.npz
    python analyses/running_c_and_skew.py --shuffles 200 --temperature 300
"""
...
def main():
    ...
    out = ((Path(args.outdir) if args.outdir else HERE) / "running_c_and_skew.png")
