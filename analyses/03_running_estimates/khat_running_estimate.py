...
Beispiele:
    python analyses/khat_running_estimate.py \
        --weights cache/mace_energies_ensemble_L2c_testbig.npz
    python analyses/khat_running_estimate.py --source pareto --alpha 1.25 -n 3000
"""
...
def main():
    ...
    ap.add_argument("--weights", default=None,
                    help="vorhandene Datei (.npy/.npz/.txt/.csv): fertige w_i ODER "
                         "Energie-Cache mit e_dft/e_mace (z.B. cache/mace_energies_*.npz)")
    ...
    plot(ks, med, lo, hi, w, label, HERE / f"khat_running_{tag}.png")
