...
Ausgabe:
    (Ausgabeordner) khat_vs_neff_regime.png    Hauptabbildung (4 Panels)
    (Ausgabeordner) finite_size_effect.png     k_hat und Bias als Funktion von n
    (Ausgabeordner) regime_table.csv           alle Zahlen

Ausfuehren:
    python analyses/khat_vs_neff_regime.py
    python analyses/khat_vs_neff_regime.py --n 5000 --reps 40 --cmax 3.0
    python analyses/khat_vs_neff_regime.py --real cache/mace_energies_ensemble_L2c_testbig.npz
"""
